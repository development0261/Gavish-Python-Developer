...
class EmployeeSlots(models.Model):
    ...
    meetingfromtime=models.CharField(blank=True,max_length=20, null=True,db_column='MeetingFromTime')
    meetingtotime=models.CharField(blank=True,max_length=20, null=True,db_column='MeetingToTime')
